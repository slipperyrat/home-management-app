...
export async function POST(
  ...
  try {
    const { householdId } = IncrementQuotaSchema.parse({ householdId: (await params).householdId });
    ...
    // Call the increment_quota_usage function
    ...
    console.error('Error in POST /api/entitlements/[householdId]/increment-quota:', error);
