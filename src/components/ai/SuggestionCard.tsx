...
export function SuggestionCard({ suggestion, onCorrectionSaved }: SuggestionCardProps) {
  ...
  const getSuggestionColor = (type: string) => {
    switch (type) {
      case 'bill_action': return 'bg-red-100 text-red-800 border-red-200';
      case 'shopping_list_update': return 'bg-green-100 text-green-800 border-green-200';
      case 'calendar_event': return 'bg-blue-100 text-blue-800 border-blue-200';
      case 'chore_creation': return 'bg-purple-100 text-purple-800 border-purple-200';
