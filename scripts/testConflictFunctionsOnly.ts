#!/usr/bin/env tsx
/**
 * Test conflict detection functions without triggers
 */
...
async function testConflictFunctionsOnly() {
  console.log('🧪 Testing conflict detection functions only...');
